...
try {
 ...
 $rows=$pdo->query("SELECT alarm_type,severity,status,interface_name,message,value,threshold,created_at,resolved_at FROM alarms WHERE created_at >= DATE_SUB(NOW(),INTERVAL 30 DAY) ORDER BY created_at ASC")->fetchAll(PDO::FETCH_ASSOC);
