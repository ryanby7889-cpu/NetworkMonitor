...
<header class="bd-header">
  <div><h1>Dashboard Billing</h1><p>Monitoring pelanggan, tagihan, pembayaran, piutang, dan jatuh tempo PPPoE</p></div>
  <div class="bd-actions"><input id="month" type="month" class="bd-input"><button id="refreshBtn" class="bd-btn"><i class="bi bi-arrow-clockwise"></i> Refresh</button><button id="printBtn" class="bd-btn"><i class="bi bi-printer"></i> Cetak</button></div>
</header>
...
<div class="bd-grid">
<section class="bd-card"><div class="bd-card-head"><div><h2>Grafik Pendapatan 12 Bulan</h2><p>Tagihan dibandingkan dengan pembayaran diterima.</p></div></div><div class="bd-chart"><canvas id="revenueChart"></canvas></div></section>
<section class="bd-card"><div class="bd-card-head"><div><h2>Status Invoice</h2><p id="statusPeriod">Bulan terpilih</p></div></div><div class="bd-chart bd-chart-sm"><canvas id="statusChart"></canvas></div><div id="statusList" class="bd-status-list"></div></section>
</div>
...
<div class="bd-grid">
<section class="bd-card"><div class="bd-card-head"><div><h2>Jatuh Tempo 7 Hari</h2><p>Prioritas penagihan berikutnya.</p></div><a class="bd-text-link" href="../billing/index.php#invoiceSection">Lihat Invoice</a></div><div class="bd-table-wrap"><table class="bd-table"><thead><tr><th>Invoice</th><th>Pelanggan</th><th>Jatuh Tempo</th><th>Jumlah</th><th>Hari</th></tr></thead><tbody id="upcoming"></tbody></table></div></section>
<section class="bd-card"><div class="bd-card-head"><div><h2>Top Piutang</h2><p>Pelanggan dengan tunggakan terbesar.</p></div><a class="bd-text-link" href="../billing/index.php#invoiceSection">Kelola</a></div><div class="bd-table-wrap"><table class="bd-table"><thead><tr><th>Pelanggan</th><th>PPPoE</th><th>Invoice</th><th>Piutang</th><th>Hari</th></tr></thead><tbody id="arrears"></tbody></table></div></section>
</div>
