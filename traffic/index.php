...
if (count($data) > 0) {
    ...
    $downloadValues = array_column(
        $data,
        'download_mbps'
    );

    $uploadValues = array_column(
        $data,
        'upload_mbps'
    );
    ...
    $avgDownload =
        array_sum($downloadValues)
        / count($downloadValues);

    $avgUpload =
        array_sum($uploadValues)
        / count($uploadValues);
}
...
<!-- Ikon sidebar harus sama dengan Dashboard. -->
<link
...
<div class="content">
    ...
    <div class="subtitle">
        ...
        Historical MikroTik Ether1 traffic monitoring
    ...
    <div class="d-flex gap-2">
        ...
        <a
            href="export.php?start=<?= urlencode($start) ?>&end=<?= urlencode($end) ?>"
