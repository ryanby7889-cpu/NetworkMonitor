...
|--------------------------------------------------------------------------
| The Alarm page must not keep an offline alarm after the web application
| has successfully reached RouterOS. This is especially important when a
| CLI collector has a transient connection failure.
*/
    ...
    <div class="d-flex
        ...
        <div>
            ...
            <div class="subtitle">
                ...
                Real-time MikroTik Ether1 alarm monitoring
...
async function checkMonitoringStatus() {
    ...
    try {
        ...
        const response = await fetch(
            "../api/traffic.php?nocache=" + Date.now(),
            {
                cache: "no-store"
            }
        );
...
/*
|--------------------------------------------------------------------------
| AUTO REFRESH ALARM DATA
|--------------------------------------------------------------------------
| Reload halaman setiap 10 detik agar:
| - Active Alarm terbaru
| - Alarm History terbaru
| - Status alarm
| - Created / Resolved
| selalu mengambil data terbaru dari database.
|--------------------------------------------------------------------------
*/
